...
# ===========================
def train_magpieEX_baseline(data_file="thermalconductivity_K_total3149.json", n_splits=5, length=-1, model_type="rf"):
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(df)):
        ...
        fold_dir = f"Thermo_MagpieEX_{model_type.upper()}_{fold}"
        ...
        dump(model, os.path.join(fold_dir, f"{model_type}_model.joblib"))
    ...
    with open(f"MagpieEX_{model_type}_results.txt", "w") as f:
    ...
    print(f"Saved MagpieEX_{model_type}_results.txt")


if __name__ == "__main__":
    tqdm.pandas()
    # Run Random Forest baseline
    train_magpieEX_baseline(data_file="../../farm/thermalconductivity_K_total3149.json", n_splits=5, model_type="rf")

    # Run MLP baseline
    train_magpieEX_baseline(data_file="../../farm/thermalconductivity_K_total3149.json", n_splits=5, model_type="mlp")
